...
namespace srrg2_proslam {
  ...
  public:
    ...
    void setTransition(const TransformType& transition_,
                       const StateMatrixType& covariance_ = StateMatrixType::Zero()) {
      _transition            = transition_;
      _transition_covariance = covariance_;
    }
    void
  ...
  protected:
    ...
    void _predict() {
      ...
      const StateMatrixType transition_jacobian(_transition.linear());
    ...
    TransformType _transition;
    StateMatrixType _transition_covariance;
