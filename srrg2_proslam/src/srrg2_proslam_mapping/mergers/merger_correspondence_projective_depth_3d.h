...
#include <srrg_slam_interfaces/merger_correspondence_homo.h>
#include <srrg_system_utils/profiler.h>

namespace srrg2_proslam {

  class MergerCorrespondenceProjectiveDepth3D
    : public srrg2_slam_interfaces::MergerCorrespondence3D,
      public srrg2_core::Profiler {
  public:
    using BaseType = srrg2_slam_interfaces::MergerCorrespondence3D;
