...
#include "srrg2_proslam_mapping/landmarks/landmark_estimator_base.hpp"

namespace srrg2_proslam {

  // ds binning bookkeeping TODO refactor
  using BinMap =
  ...
  public:
    ...
    using ProjectoryPtrType         = std::shared_ptr<ProjectoryType>;
    using LandmarkEstimatorType =
      srrg2_slam_interfaces::LandmarkEstimatorBase_<typename MeasurementPointType::VectorType,
                                                    ScenePointType>;
    using LandmarkEstimatorPtrType = std::shared_ptr<LandmarkEstimatorType>;
