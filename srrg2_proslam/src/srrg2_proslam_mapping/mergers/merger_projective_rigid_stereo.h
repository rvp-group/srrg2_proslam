...
#include "srrg2_proslam_mapping/triangulator_rigid_stereo.h"
...
namespace srrg2_proslam {
  ...
  public:
    ...
    PARAM(
      srrg2_core::PropertyConfigurable_<srrg2_slam_interfaces::TriangulatorRigidStereoDescriptors>,
      triangulator,
      "rigid stereo triangulation unit",
      srrg2_slam_interfaces::TriangulatorRigidStereoDescriptorsPtr(
        new srrg2_slam_interfaces::TriangulatorRigidStereoDescriptors()),
      nullptr);
