...
namespace srrg2_core {
  ...
  class TriangulatorRigidStereo : public Configurable, public PlatformUser, public Profiler {
    ...
    using ProjectorType               = CameraMatrixOwner_<PointType::GeometryDim>;
  ...
  public:
    ...
    PARAM(PropertyFloat,
          ...
          nullptr);
    PARAM(PropertyConfigurable_<ProjectorType>,
          projector,
    ...
    const Vector3Type& baseline() const {
      return _baseline_left_to_right;
    }
  ...
  protected:
    ...
    Vector3Type _baseline_left_to_right = Vector3Type::Zero();
