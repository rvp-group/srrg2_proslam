...
namespace srrg2_slam_interfaces {
  ...
  using CorrespondenceCandidateMap =
    std::unordered_map<size_t /*fixed index*/, CorrespondenceVector>;
  ...
  protected:
    ...
    void _filterCorrespondences(CorrespondenceCandidateMap& correspondence_candidate_map_fixed_,
  ...
  protected:
    ...
    TransformType _estimate_moving_from_fixed_previous;
