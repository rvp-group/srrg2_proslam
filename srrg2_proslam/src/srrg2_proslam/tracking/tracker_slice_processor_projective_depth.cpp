...
namespace srrg2_proslam {
  ...
  //  void TrackerSliceProcessorProjectiveDepth::merge() {
  //    sanityCheck("MultiTrackerSlice_::merge()");
  //    assert(param_merger.value());
  //
  //    // ds prepare merger
  //    param_merger->setScene(_scene_slice);
  //    param_merger->setMoving(&(ThisType::_measurement_slice));
  //
  //    param_merger->setTransform(ThisType::_robot_in_local_map * ThisType::_sensor_in_robot);
  //
  ...
  //      ThisType::_robot_in_local_map * ThisType::_sensor_in_robot);
  //
  ...
  //        throw std::runtime_error("MultiTrackerSlice::merge|ERROR: correspondence-based merger
  //        for "
  ...
  //    }
  //
  //    // ds clipped scene (which carries correspondences) must be available for correspondence
  //    merger if (!ThisType::_clipped_scene_container) {
  //      throw std::runtime_error(
  //        "MultiTrackerSlice::merge|ERROR: auxiliary data not available for correspondence
  //        import");
  //    }
  //
  ...
  //
  //  void TrackerSliceProcessorProjectiveDepth::clip() {
  ...
  //
  //    param_clipper->setTransform(ThisType::_sensor_in_robot * ThisType::_robot_in_local_map *
